      ...
      var exit = {
        wrapper: function (element, settings) {
          ...
          element.css({
            ...
            'pointer-events': 'none',
            'border-radius' : '30px',
            '-webkit-transition': 'opacity 0.3s 0.5s, width 0.35s 0.1s, height 0.35s 0.1s, top 0.35s 0.1s, left 0.35s 0.1s, margin 0.35s 0.1s, border-radius 0.35s 0.1s',
            'transition': 'opacity 0.3s 0.5s, width 0.35s 0.1s, height 0.35s 0.1s, top 0.35s 0.1s, left 0.35s 0.1s, margin 0.35s 0.1s, border-radius 0.35s 0.1s'
          });
        },
        content: function (element, settings) {
          element.css({
